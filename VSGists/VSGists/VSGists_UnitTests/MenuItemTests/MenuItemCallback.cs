...
using DavidNewman.VSGists;

namespace VSGists_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSGistsPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(DavidNewman.VSGists.GuidList.guidVSGistsCmdSet, (int)DavidNewman.VSGists.PkgCmdIDList.cmdidVSGists);
