...
namespace VSGists_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(DavidNewman.VSGists.GuidList.guidVSGistsCmdSet, (int)DavidNewman.VSGists.PkgCmdIDList.cmdidVSGists);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSGists", "DavidNewman.VSGists.VSGistsPackage");
